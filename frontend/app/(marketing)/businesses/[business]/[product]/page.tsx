...
import SolarCalcClient from './SolarCalcClient';
    ...
    <>
      ...
      <main id="main-content">
          ...
          <div className="container-content">
            <nav aria-label="Breadcrumb" className="mb-6">
              <ol className="flex flex-wrap items-center gap-1 text-sm text-[var(--fg-subtle)] list-none p-0 m-0">
                ...
                <li>
                  <span aria-hidden="true" className="mx-1">/</span>
                  <Link href={businessHref(bizSlug)} className="hover:text-[var(--accent)] transition-colors">
                    {biz.title}
                  </Link>
                </li>
                <li>
        ...
        <section className="bg-[var(--bg)] py-12 md:py-16">
          <div className="container-content">
            {isCalculator ? (
              /* Client component — ssr:false lives inside SolarCalcClient.tsx */
              <SolarCalcClient />
            ) : (
